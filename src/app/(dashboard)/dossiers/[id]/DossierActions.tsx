...
import { archiveDossier, deleteDossier } from '@/app/(dashboard)/dossiers/[id]/actions'
              ...
              <>
                ...
                <p style={{ fontSize: 14, color: 'var(--text-secondary)', marginBottom: 24 }}>
                  {isArchived
                    ...
                    : "Le dossier disparaîtra de la liste active mais restera consultable via les filtres."}
                </p>
                ...
                {hasContent ? (
                  <div style={{ background: '#fef2f2', border: '1px solid #fecaca', padding: 16, borderRadius: 'var(--radius-md)', marginBottom: 20 }}>
                    ...
                    <p style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
                      La suppression détruira toutes ces données. Préférez l&apos;archivage pour garder l&apos;historique.
                    </p>
                  </div>
                ) : (
                  <p style={{ fontSize: 14, color: 'var(--text-secondary)', marginBottom: 24 }}>
